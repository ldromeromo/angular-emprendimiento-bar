...
@Component({
  ...
  styleUrls: ['./scale-deployment.component.scss'],
  providers: [MessageService]
})
export class ScaledeploymentComponent implements OnInit {
  ...
  escalado(replica: number): void {
    ...
    const data = {
      ...
      "namespace_id": formData.namespace,
    ...
    let url = 'https://portalcloud.telefonicawebsites.co/api-ambientes-test/telefonica/service/v1/api-ambientes-test/update_namespace';
    if (selectedCluster.platform === "OpenShift") {
      url = 'https://portalcloud-desa.telefonicawebsites.co/api-ocp-test/telefonica/service/v1/api-ocp-test/update_namespace';
    }
